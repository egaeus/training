                                ...
                                for (int j = -1; j < 2; j += 2) {
                                    for (int k = 0; k < 2; k++) {
                                        long[][] solutions = new long[][]{
                                                {(long) Math.floor(circulo[0] + j * i * k), (long) Math.floor(circulo[1] + j * i * (k + 1) % 2)},
                                                {(long) Math.floor(circulo[0] + j * i * k), (long) Math.ceil(circulo[1] + j * i * (k + 1) % 2)},
                                                {(long) Math.ceil(circulo[0] + j * i * k), (long) Math.floor(circulo[1] + j * i * (k + 1) % 2)},
                                                {(long) Math.ceil(circulo[0] + j * i * k), (long) Math.ceil(circulo[1] + j * i * (k + 1) % 2)}
                                        };
                                        for (int h = 0; h < solutions.length && result == null; h++) {
                                            System.out.println(solutions[h][0] + " " + solutions[h][1]);
